...
AuthConfig = BearerAuthConfig | BasicAuthConfig | OAuth2AuthConfig | OAuth2PasswordAuthConfig | CallbackAuthConfig
...
class SchemaBuilder:
    ...
    def oauth2(self, token_url: str, client_id: str, client_secret: str,
               scope: str | None = None, expiry_margin: int = 60) -> SchemaBuilder:
        cfg: dict = {
            'type': 'oauth2',
            'token_url': token_url,
            'client_id': client_id,
    ...
    def session_config(self,
                       ...
                       max_redirects: int | None = None) -> SchemaBuilder:
        '''
    ...
    def retry(self, max_attempts: int = 3,
              ...
              max_retry_after: float | None = None) -> SchemaBuilder:
        cfg = {
    ...
    def rate_limit(self, min_delay: float = 0.0,
                   respect_retry_after: bool = True) -> SchemaBuilder:
    ...
    def on_event_kinds(self, kinds: None | str | set[str] | list[str] | frozenset[str]) -> SchemaBuilder:
        'filter which event kinds reach on_event — raw value, normalized during validation'
        self._schema['on_event_kinds'] = kinds
        return self

    # endpoints
    def endpoint(self, name: str, *, method: str = 'GET', path: str = '',
                 **kwargs: Any) -> SchemaBuilder:
        '''
