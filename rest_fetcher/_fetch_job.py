...
from ._job_config import _MISSING, _has_token_bucket_config, _resolve_job_config
...
from .pagination import StateView
from .parsing import default_parse_response, serialize_response_for_playback
from .playback import _scrub, _scrub_playback_envelope, deserialize_playback_response
...
from .types import StopSignal, StreamSummary
...
class _FetchJob:
    ...
    def __init__(
        ...
        resolved = _resolve_job_config(client_schema, self._cfg, self._call_params)
